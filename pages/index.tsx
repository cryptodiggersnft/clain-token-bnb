      ...
      <Flex h={"75vh"} px={20} borderRadius={20} >
        <Flex flexDirection={"row"}>
          <Flex flexDirection={"column"} justifyContent={"center"} w={"60%"}>
            <Stack spacing={4}>
              <Heading color="white" fontSize={"xl"}>Withdraw TokenApp</Heading>
...
Connect your wallet to get started now!
  ...
  description={"You need to click above the token to call up the token balance of your wallet."}
/>
            <FeatureCard
              step={"02"}
              title={"Amount:"}
              description={"Enter the amount to withdraw from your wallet"}
            />
            <FeatureCard
              step={"03"}
              title={"Write a Message"}
              description={"Write a message to accompany your token withdrawal. This is optional but it is always good to send a message to the game devs."}
            />
          </Stack>
        </Flex>
      </SimpleGrid>
